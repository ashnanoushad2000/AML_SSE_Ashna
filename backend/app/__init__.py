...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:ashna12@localhost/auth_db?charset=utf8mb4'
    app.config['SQLALCHEMY_BINDS'] = {
        'auth_db': 'mysql+pymysql://root:ashna12@localhost/auth_db?charset=utf8mb4',
