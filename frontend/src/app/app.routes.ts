...
export const routes: Routes = [
  {
    path: 'login',
    component: LoginPageComponent // ✅ Added for SR2 redirect
  },
  {
    path: '',
  ...
  {
    path: 'single_media_addition',
    component: SingleMediaAdditionComponent
  },
  {
    path: 'home',
  ...
  },
  {
    ...
    canActivate: [AdminGuard, StaffGuard]
  },
  {
  ...
  {
    path: 'transfer_initiation',
    component: TransferInitiationComponent,
    canActivate: [StaffGuard, AdminGuard]
  },
  {
    path: 'staff_homepage',
...
// ✅ Make sure this is used in your AppModule or AppComponent
